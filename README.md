...
Desarrollar un sistema web para la gestión de ventas que optimice el control de inventario y registros de ventas.
  ...
  Implementación:
  - Utilizamos Werkzeug para subir archivos
  - Validamos extensiones permitidas (PNG, JPG, GIF)
  - Las imágenes se guardan en app/static/uploads/
  - Se muestran en Flask-Admin con column_formatters
